...
public class DarkForestLocation implements LocationStrategy {
    ...
    private static final Tile FOREST_TREE_LU = new AnimatedBasicTile(17, new int[][] {{0, 6}, {2, 6}, {0, 6}, {4, 6}, {0, 6}},
            Colours.get(021, 000, 210, 013), 0xFF403020, 750, true);
    private static final Tile FOREST_TREE_RU = new AnimatedBasicTile(18, new int[][] {{1, 6}, {3, 6}, {1, 6}, {5, 6}, {1, 6}},
            Colours.get(021, 000, 210, 013), -1, 750, true);
    private static final Tile FOREST_TREE_LD = new AnimatedBasicTile(19, new int[][] {{0, 7}, {2, 7}, {0, 7}, {4, 7}, {0, 7}},
            Colours.get(021, 000, 210, 013), -1, 750, true);
    private static final Tile FOREST_TREE_RD = new AnimatedBasicTile(20, new int[][] {{1, 7}, {3, 7}, {1, 7}, {5, 7}, {1, 7}},
            Colours.get(021, 000, 210, 013), -1, 750, true);

    private static final Tile FOREST_GRASS_LU = new AnimatedBasicTile(21, new int[][] {{6, 6}, {8, 6}, {10, 6}, {6, 6}},
            Colours.get(013, 000, 121, -1), 0xFF002030, 750, false);
    private static final Tile FOREST_GRASS_RU = new AnimatedBasicTile(22, new int[][] {{7, 6}, {9, 6}, {11, 6}, {7, 6}},
            Colours.get(013, 000, 121, -1), -1, 750, false);
    private static final Tile FOREST_GRASS_LD = new AnimatedBasicTile(23, new int[][] {{6, 7}, {8, 7}, {10, 7}, {6, 7}},
            Colours.get(013, 000, 121, -1), -1, 750, false);
    private static final Tile FOREST_GRASS_RD = new AnimatedBasicTile(24, new int[][] {{7, 7}, {9, 7}, {11, 7}, {7, 7}},
            Colours.get(013, 000, 121, -1), -1, 750, false);

    private static final Tile FOREST_FIREFLY_LU = new AnimatedBasicTile(25, new int[][] {{6, 8}, {8, 8}, {10, 8}, {6, 8}},
            Colours.get(013, 000, 121, 043), 0xFF002090, 750, false);
    private static final Tile FOREST_FIREFLY_RU = new AnimatedBasicTile(26, new int[][] {{7, 8}, {9, 8}, {11, 8}, {7, 8}},
            Colours.get(013, 000, 121, 043), -1, 750, false);
    private static final Tile FOREST_FIREFLY_LD = new AnimatedBasicTile(27, new int[][] {{6, 9}, {8, 9}, {10, 9}, {6, 9}},
            Colours.get(013, 000, 121, 043), -1, 750, false);
    private static final Tile FOREST_FIREFLY_RD = new AnimatedBasicTile(28, new int[][] {{7, 9}, {9, 9}, {11, 9}, {7, 9}},
            Colours.get(013, 000, 121, 043), -1, 750, false);

    private static final Tile FOREST_EXIT_LU = new AnimatedActiveTile(29, new int[][] {{12, 6}, {14, 6}, {16, 6}},
            Colours.get(431, 000, 013, 043), 0xFF00FFFF, 750, false);
    private static final Tile FOREST_EXIT_RU = new AnimatedActiveTile(30, new int[][] {{13, 6}, {15, 6}, {17, 6}},
            Colours.get(431, 000, 013, 043), -1, 750, false);
    private static final Tile FOREST_EXIT_LD = new AnimatedActiveTile(31, new int[][] {{12, 7}, {14, 7}, {16, 7}},
            Colours.get(431, 000, 013, 043), -1, 750, false);
    private static final Tile FOREST_EXIT_RD = new AnimatedActiveTile(32, new int[][] {{13, 7}, {15, 7}, {17, 7}},
            Colours.get(431, 000, 013, 043), -1, 750, false);
