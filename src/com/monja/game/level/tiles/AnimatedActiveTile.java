...
public class AnimatedActiveTile extends BasicTile implements Animated, Active {
    ...
    public AnimatedActiveTile(int id, int[][] animationCoords, int tileColour, int levelColour, int animationSwitchDelay, boolean isSolid) {
